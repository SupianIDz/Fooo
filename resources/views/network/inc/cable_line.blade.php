            ...
            <div class="mt-2 p-5 rounded-lg border w-full" x-show="row.show">
                <div class="flex flex-row mb-3 w-full space-x-3">
                    ...
                    <div class="w-1/6 mt-9 pl-3">
                        <label :for="'default-toggleCableCore' + indexCableLine" class="inline-flex relative items-center cursor-pointer">
                            <input type="checkbox" value="" :id="'default-toggleCableCore' + indexCableLine" class="sr-only peer" x-model="row.manual"
