<div class="w-full">
    <div class="flex justify-end my-3 space-x-3">
        <button type="button" x-on:click="addCableToODC(odc)"
    ...
    <template x-for="(row, indexODCLine) in odc.lines" :key="indexODCLine">
        <div class="w-full bg-white shadow-lg p-2 px-4 mb-3 border last:mb-0 rounded-lg hover:shadow">
            <div class="grid grid-cols-2 items-center ">
                <div class="flex items-center space-x-3">
                    <svg x-on:dblclick="removeODCLine(odc, indexODCLine)" class="w-5 h-5 cursor-pointer fill-rose-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <div class="flex items-center justify-end">
                    <svg x-on:click="toggle(row, indexODCLine)" x-show="!row.show" class="w-5 h-5 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                         xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-row mb-3 w-full space-x-3">
                    ...
                    <div x-show="!row.manual" class="w-3/6">
                        ...
                        <select class="form" :id="'selectODCMarker' + indexODC + '_' + indexODCLine"
                                x-init="$nextTick(() => initSelectODC(row, indexODC, indexODCLine))">
                    ...
                    <div class="w-1/6 mt-9 pl-3">
                        <label :for="'toggleManualODC' + indexODC + indexODCLine" class="inline-flex relative items-center cursor-pointer">
                            <input type="checkbox" value="" :id="'toggleManualODC' + indexODC + indexODCLine" class="sr-only peer" x-model="row.manual"
